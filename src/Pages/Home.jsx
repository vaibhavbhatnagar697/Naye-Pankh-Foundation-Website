    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="rounded-3xl h-80 bg-gradient-to-r from-blue-500 to-purple-600 shadow-2xl hover:scale-105 transition duration-500">
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKE-1w8TcBGm-pnqdlCeqf7veHMlgNVTBM62alCDIzJQ&s=10"
                alt="Children learning through NayePankh Foundation"
